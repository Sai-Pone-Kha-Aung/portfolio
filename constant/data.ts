...
export const experiencesData = [
  {
    ...
    description:
      "As a Senior Software Engineer, I am responsible for the end-to-end system architecture and technical leadership for an AI-powered ebook and audiobook platform. This involves designing the entire application stack and implementing a scalable and cost-effective infrastructure.",
    ...
    achievements: [
      "System Design & Architecture: Designed the complete system from the ground up, covering the mobile, frontend web, admin dashboards, and backend services, ensuring a cohesive and scalable cross-platform architecture.",
      "Cost Optimization: Conducted in-depth analysis to calculate and implement the most efficient and cost-effective production solutions, leading to significant savings without compromising performance.",
      "CI/CD & DevOps: Established a robust CI/CD pipeline, integrating AWS, Supabase, Vercel, and GitHub Actions, which automated testing with Cypress and streamlined deployments.",
      "Implementation & Leadership: Led the implementation of the UI for both frontend web and mobile applications, personally handling 80% of the development and contributing 20% to backend services.",
      "Cross-Platform Development: Developed a unified codebase for both web and mobile platforms, ensuring a consistent user experience across devices.",
      "Agile Development: Instituted and managed the Agile framework for the development team, improving collaboration and project delivery speed.",
    ],
    projects: [
      "Online Ebook Reader",
      "Audiobook Generated by AI",
      "AI-Powered Audiobook or Ebook Translation",
    ],
    images: ["/experience/Home/fungin.webp"],
  },
  {
    company: "MEW Int Ltd",
    title: "Software Engineer",
...
export const projectsData = [
  {
    ...
    imageUrl: nearabac,
    url: "https://github.com/Sai-Pone-Kha-Aung/near_abac.git",
  },
  {
  ...
  },
  {
    ...
    imageUrl: ecommerce,
    url: "https://github.com/Sai-Pone-Kha-Aung/mwe-frontend.git",
  },
  {
...
export const skills = [
  ...
  },
  {
    ...
    icon: React.createElement(SmartphoneIcon, { className: "h-10 w-10" }),
    technologies: ["React Native", "Android", "iOS"],
  },
  {
    title: "DevOps",
    description:
      "Implementing CI/CD pipelines and infrastructure as code (still learning)",
    icon: React.createElement(Cloud, { className: "h-10 w-10" }),
...
export const projects = [
  ...
  },
  {
    id: 8,
    slug: "prompt-boost",
    title: "Chrome Extension Prompt Boost",
    description:
      "A Chrome extension that enhances the prompt to get a better result while working with AI.",
    image: "/projects/promptboost.png",
    tags: ["JavaScript", "HTML", "CSS", "Bash"],
    category: "extension",
    liveLink: "",
    githubLink: "https://github.com/Sai-Pone-Kha-Aung/prompt_boost.git",
    overview:
      "A Chrome extension that enhances the prompt to get a better result while working with AI.",
    challenge:
      "The main challenge was to create a dynamic prompt system that allows users to easily modify and enhance their prompts. Additionally, I needed to ensure that the extension could handle various AI models and to get the better prompt enhancement.",
    solution:
      "I implemented a Chrome extension using JavaScript, HTML, and CSS. The extension features a user-friendly interface that allows users to easily modify their prompts and applied the prompt engineering techniques to get the best results while working with AI. I also integrated various AI models to provide relevant.",
    features: [
      "Dynamic prompt modification",
      "Working on LLM - ChatGpt, Gemini, Grok and DeepSeek",
      "Integration with multiple AI models",
      "User-friendly interface",
      "Cross-platform compatibility",
      "Save all user data on their local browser",
    ],
    techStack: {
      frontend: ["Vanilla JavaScript", "HTML", "CSS"],
      backend: ["Vanilla JavaScript"],
    },
    screenshots: ["/projects/promptboost.png"],
  },
  {
    id: 9,
    ...
    image: "/projects/ai content agent.png",
    tags: ["Python", "LLM", "Notion", "Ollama", "Streamlit"],
    category: "AI",
    liveLink: "",
    githubLink: "https://github.com/Sai-Pone-Kha-Aung/content-generator.git",
    overview:
      "A powerful AI-powered content generation tool with Notion integration, built using Streamlit. This application allows you to generate various types of content using multiple LLM providers and automatically save them to your Notion workspace.",
    challenge:
      "The main challenge was to integrate with database that is provided for who don't know how to store their data. Additionally, I needed to ensure that the application could handle multiple LLM providers and provide a seamless user experience.",
    solution:
      "I implemented a comprehensive solution that includes a user-friendly interface for content generation, integration with multiple LLM providers, and automatic saving of content to Notion. This ensures that users can easily create and manage their content without worrying about the underlying data storage.",
    features: [
    ...
    screenshots: [
      "/projects/ai content agent.png",
      "/projects/ai content agent library.png",
      "/projects/ai content agent settings.png",
      "/projects/ai content agent status.png",
    ],
  },
  {
    id: 10,
    slug: "coverletter-generator",
    title: "Cover Letter Generator",
    description:
      "The Cover Letter Generator is a web-based application that helps users create professional cover letters quickly and easily. It features a user-friendly interface, customizable templates, and real-time suggestions.",
    image: "/projects/AI Cover Letter Generator.jpeg",
    tags: ["Python", "StreamLit", "Ollama", "LLM"],
    category: "AI",
    liveLink: "",
    githubLink:
      "https://github.com/Sai-Pone-Kha-Aung/cover-letter-generator.git",
    overview:
      "The Cover Letter Generator is a web-based application that helps users create professional cover letters quickly and easily. It features a user-friendly interface, customizable templates, and real-time suggestions.",
    challenge:
      "The main challenge was to create a dynamic template system that allows users to mix and match different sections and styles. Additionally, I needed to ensure that the application could handle real-time suggestions without compromising performance.",
    solution:
      "I implemented a comprehensive solution that includes a user-friendly interface for content generation, integration with multiple LLM providers, and automatic saving of content to Notion. This ensures that users can easily create and manage their content without worrying about the underlying data storage.",
    features: [
      "Generate the cover letter using LLM with optimized prompt engineering",
      "User-friendly interface for easy navigation",
      "Export and save generated cover letters",
    ],
    techStack: {
      frontend: ["Streamlit", "Python"],
    },
    screenshots: ["/projects/AI Cover Letter Generator.jpeg"],
  },
];
